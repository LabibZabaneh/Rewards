...
public class UsersStreams {
    ...
    public KStream<Long, UserDTO> createdUsers(ConfiguredStreamBuilder builder) {
        ...
        KStream<Long, UserDTO> createdUsersStream = builder.stream(UsersConsumer.USER_CREATED_TOPIC, Consumed.with(Serdes.Long(), serdeRegistry.getSerde(UserDTO.class)));
